            ...
            <main className="container mx-auto px-4 py-8 lg:py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg md:text-xl text-[#83a0b5] max-w-2xl mx-auto">
                        Aprende a integrar herramientas de Inteligencia Artificial en tu proceso creativo y operativo para potenciar tu productividad.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <aside className="lg:col-span-1 space-y-8 order-2 lg:order-1">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                            ...
                            <ul className="space-y-4">
                                <li>
                                    <Link href="/ia-prompts-revit" className="group flex flex-col">
                                        <span className="text-[#ea7048] font-bold group-hover:underline flex items-center gap-2">
                                            🤖 Prompts para Revit
                                        </span>
                                        <span className="text-xs text-gray-400 mt-1">Chat GPT + Revit API</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/ia-prompts-autocad" className="group flex flex-col">
                                        ...
                                        <span className="text-xs text-gray-400 mt-1">Midjourney y ControlNet</span>
                                    </Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-[#2f4860]/5 rounded-2xl p-6 border border-[#2f4860]/10">
                            ...
                            <div className="space-y-4">
                                <div className="p-3 border border-dashed border-gray-300 rounded-xl opacity-60 bg-purple-50/30">
                                    <span className="block text-sm font-bold text-[#2f4860] uppercase">Stable Diffusion Avanzado</span>
                                ...
                                <div className="p-3 border border-dashed border-gray-300 rounded-xl opacity-50">
                                    <span className="block text-sm font-bold text-gray-500 uppercase">IA en Gestión Inmobiliaria</span>
                                    <span className="text-xs text-gray-400">En desarrollo</span>
                                </div>
                                <div className="p-3 border border-dashed border-gray-300 rounded-xl opacity-50">
                                    <span className="block text-sm font-bold text-gray-500 uppercase">Scripting con LLMs</span>
                                    <span className="text-xs text-gray-400">Próximamente</span>
                                </div>
                                <div className="p-3 border border-dashed border-gray-300 rounded-xl opacity-50">
                                    <span className="block text-sm font-bold text-gray-500 uppercase">Post-producción con IA</span>
                    ...
                    <div className="lg:col-span-3 order-1 lg:order-2 space-y-8">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                type="text"
                                placeholder="Buscar tutoriales (ej. Midjourney, Stable Diffusion, GPT...)"
                                            ...
                                            <div className="md:col-span-3 p-6 flex flex-col justify-between">
                                                <div>
                                                    <div className="flex items-center justify-between mb-2">
                                                        <span className="bg-purple-100 text-purple-600 px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-wider">
                                                            Tendencia IA
                                                        </span>
