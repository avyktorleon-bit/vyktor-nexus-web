...
const categories = [
    {
        id: 'revit',
        title: 'Revit',
        description: 'Domina metodologías BIM para el diseño arquitectónico y estructural.',
        focus: 'Modelado paramétrico, coordinación de proyectos y documentación inteligente.',
        href: '/tutoriales-revit',
        icon: <Box className="w-8 h-8" />,
        color: 'from-[#2f4860] to-[#1e2e3e]', // Professional Blue
        badge: 'BIM / COORDINACIÓN'
    },
    {
        id: 'autocad',
        title: 'AutoCAD',
        description: 'Domina el estándar de la industria para dibujo técnico 2D y 3D.',
        focus: 'Desde comandos esenciales hasta bloques dinámicos y automatización LISP.',
        href: '/tutoriales-autocad',
        icon: <Layout className="w-8 h-8" />,
        color: 'from-[#52aeb2] to-[#45969a]', // Brand Teal
        badge: 'DIBUJO TÉCNICO'
    },
    {
        id: 'etabs',
        title: 'ETABS',
        description: 'Especialízate en el análisis y diseño estructural de edificaciones.',
        focus: 'Verificación sísmica, optimización de elementos y diseño de concreto/acero.',
        href: '/tutoriales-etabs',
        icon: <Calculator className="w-8 h-8" />,
        color: 'from-[#ea7048] to-[#d15d36]', // Brand Orange
        badge: 'CÁLCULO ESTRUCTURAL'
    }
];
        ...
        <div className="min-h-screen bg-[#dde8f4] font-sans text-[#2f4860]">
                ...
                <div className="container mx-auto relative z-10 text-center max-w-4xl">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight uppercase tracking-tight">
                            TUTORIALES ESPECIALIZADOS <br className="hidden md:block" />
                        ...
                        <p className="text-xl md:text-2xl text-gray-300 mb-0 leading-relaxed max-w-3xl mx-auto">
                            Domina las herramientas líderes de la industria y potencia tu flujo de trabajo profesional con mi contenido técnico especializado.
                        </p>
                    </motion.div>
                </div>
            </section>
                        ...
                        >
                            ...
                            <Link href={item.href} className="group/btn relative overflow-hidden bg-gray-50 hover:bg-[#2f4860] p-5 rounded-2xl transition-all duration-300 flex items-center justify-between border border-gray-100 hover:border-[#2f4860]">
                                <span className="font-bold text-[#2f4860] group-hover/btn:text-white transition-colors">
                                    Explorar Tutoriales {item.title}
                                </span>
            ...
            <section className="container mx-auto px-4 pb-24 text-center">
                <div className="max-w-4xl mx-auto bg-white/40 backdrop-blur-sm rounded-[48px] p-12 border border-white shadow-sm ring-1 ring-black/5">
                    <PlayCircle className="w-10 h-10 text-[#52aeb2] mx-auto mb-6" />
                    <p className="text-xl md:text-2xl font-bold text-[#2f4860] leading-relaxed italic">
                        "Estoy trabajando en nuevos tutoriales de Lumion, Rhino y Grasshopper. <br className="hidden md:block" />
                        Vuelve pronto para descubrir nuevas metodologías de trabajo."
                    </p>
                </div>
            </section>
