    ...
    if (authenticated === null) {
        return (
            <div className="min-h-screen bg-[#0a192f] flex items-center justify-center">
                <LoadingOutlined className="text-4xl text-[#ea7048]" />
            </div>
        );
    }

    const widgets = [
        { title: 'Inspeccion Tecnica', icon: <ToolOutlined />, description: 'Modulo de inspeccion tecnica inmobiliaria y levantamiento de campo.', color: 'from-[#ea7048] to-[#f59e0b]', href: '/inspecciones' },
        { title: 'Calculos Estructurales', icon: <CalculatorOutlined />, description: 'Herramientas de calculo interno y verificacion tecnica.', color: 'from-[#52aeb2] to-[#4ade80]', href: '#' },
        ...
        { title: 'Base de Datos Tecnica', icon: <DashboardOutlined />, description: 'Repositorio de normas, manuales y documentos internos.', color: 'from-blue-500 to-cyan-400', href: '#' },
    ];
                ...
                <div className="mb-12">
                    ...
                    >
                        <div>
                            ...
                            <h2 className="text-4xl md:text-5xl font-black leading-tight text-[#0a0f18]">Herramientas de Gestion</h2>
                        </div>
                        <p className="max-w-md text-gray-500 text-sm md:text-base leading-relaxed">
                            Este es tu panel privado para realizar calculos rapidos, consultar materiales y gestionar datos sensibles que no son publicos.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="mt-16 bg-[#0a192f] rounded-[3rem] p-10 text-white overflow-hidden relative">
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-12">
                        <div className="lg:col-span-1">
                            <h3 className="text-2xl font-bold mb-4">Metricas de Hoy</h3>
                            <p className="text-gray-400 text-sm mb-6">Resumen rapido de actividades criticas y calculos pendientes.</p>
                            <div className="space-y-4">
                                ...
                                <div className="bg-white/5 p-4 rounded-2xl border border-white/10 flex justify-between items-center">
                                    <span className="text-gray-400">Calculos Finalizados</span>
                        ...
                        <div className="lg:col-span-2">
                            <div className="h-full bg-white/5 rounded-3xl border border-white/10 p-8 flex flex-col items-center justify-center text-center">
                                ...
                                <h4 className="text-xl font-bold mb-2">Seccion en Construccion</h4>
                                <p className="text-gray-400 max-w-sm mb-6 text-sm">Proximamente estaremos habilitando los modulos de calculo tecnico directo en esta plataforma.</p>
