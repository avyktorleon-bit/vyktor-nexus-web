...
import { revitTutorials, RevitTutorial } from '@/lib/revitTutorialsData';
...
export default function RevitTutorialsPage() {
    ...
    const sortedTutorials = [...revitTutorials].sort((a, b) =>
            ...
            <main className="container mx-auto px-4 py-8 lg:py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg md:text-xl text-[#83a0b5] max-w-2xl mx-auto">
                        Aprende BIM, modelado paramétrico y gestión de proyectos con Revit desde nivel básico hasta avanzado.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <aside className="lg:col-span-1 space-y-8 order-2 lg:order-1">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                            ...
                            <ul className="space-y-4">
                                <li>
                                    <Link href="/recursos-revit" className="group flex flex-col">
                                        <span className="text-[#ea7048] font-bold group-hover:underline flex items-center gap-2">
                                            📥 Plantillas Revit
                                        </span>
                                        <span className="text-xs text-gray-400 mt-1">Librerías y familias optimizadas</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/ia-prompts-revit" className="group flex flex-col">
                                        ...
                                        <span className="text-xs text-gray-400 mt-1">Optimización con inteligencia artificial</span>
                                    </Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-[#2f4860]/5 rounded-2xl p-6 border border-[#2f4860]/10">
                            ...
                            <div className="space-y-4">
                                <div className="p-3 border border-dashed border-gray-300 rounded-xl opacity-50">
                                    <span className="block text-sm font-bold text-gray-500 uppercase">Architecture</span>
                                    <span className="text-xs text-gray-400">Próximamente 2026</span>
                                </div>
                                <div className="p-3 border border-dashed border-gray-300 rounded-xl opacity-50">
                                    <span className="block text-sm font-bold text-gray-500 uppercase">MEP / Ingeniería</span>
                                    <span className="text-xs text-gray-400">En desarrollo</span>
                                </div>
                                <div className="p-3 border border-dashed border-gray-300 rounded-xl opacity-50">
                                    <span className="block text-sm font-bold text-gray-500 uppercase">Estructuras</span>
                    ...
                    <div className="lg:col-span-3 order-1 lg:order-2 space-y-8">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                type="text"
                                placeholder="Buscar tutoriales (ej. familias, plantillas, BIM...)"
                        ...
                        <div className="space-y-6">
                            {filteredTutorials.length > 0 ? (
                                ...
                                <div className="text-center py-20 bg-white/50 rounded-2xl border-2 border-dashed border-gray-200">
                                    ...
                                    <p className="text-gray-500 text-lg">No se encontraron tutoriales que coincidan con tu búsqueda.</p>
                                    <button
